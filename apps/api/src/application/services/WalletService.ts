...
export class WalletService {
  ...
  async creditWallet(patientId: string, amount: number, type: TransactionType, reason: string, stripeSessionId?: string, metadata?: Record<string, unknown>): Promise<Wallet> {
  ...
  async debitWallet(patientId: string, amount: number, type: TransactionType, reason: string, metadata?: Record<string, unknown>): Promise<Wallet> {
