...
const generateSlots_usecase_1 = require("@/application/use-cases/slot/generateSlots.usecase");
describe('GenerateSlotsUseCase', () => {
    ...
    beforeEach(() => {
        ...
        useCase = new generateSlots_usecase_1.GenerateSlotsUseCase(mockSlotRepo, mockDoctorRepo, mockSchedulingPolicy);
        jest.clearAllMocks();
    });
