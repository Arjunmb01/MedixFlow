...
const GetPatientFinancialActivityUseCase_1 = require("@/application/use-cases/patient/GetPatientFinancialActivityUseCase");
describe("GetPatientFinancialActivityUseCase", () => {
    ...
    beforeEach(() => {
        ...
        useCase = new GetPatientFinancialActivityUseCase_1.GetPatientFinancialActivityUseCase(mockPrisma);
    });
