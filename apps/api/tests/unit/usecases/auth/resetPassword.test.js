...
const resetPassword_usecase_1 = require("@/application/use-cases/auth/resetPassword.usecase");
...
describe('ResetPasswordUseCase', () => {
    ...
    beforeEach(() => {
        ...
        useCase = new resetPassword_usecase_1.ResetPasswordUseCase(mockAuthRepo, mockPasswordHasher);
        jest.clearAllMocks();
    });
    ...
    it('should throw error if token not found', async () => {
        ...
        await expect(useCase.execute({ token: 'invalid', password: 'pw' }))
            .rejects.toThrow(constants_1.MESSAGES.INVALID_RESET_TOKEN);
    });
