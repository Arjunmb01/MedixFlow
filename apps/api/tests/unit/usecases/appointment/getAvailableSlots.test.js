...
const getAvailableSlots_usecase_1 = require("@/application/use-cases/appointment/getAvailableSlots.usecase");
describe('GetAvailableSlotsUseCase', () => {
    ...
    beforeEach(() => {
        ...
        useCase = new getAvailableSlots_usecase_1.GetAvailableSlotsUseCase(mockAppointmentRepo);
        jest.clearAllMocks();
    });
