...
const cancelAppointment_usecase_1 = require("@/application/use-cases/appointment/cancelAppointment.usecase");
describe('CancelAppointmentUseCase', () => {
    ...
    let mockRefundAppointmentUseCase;
    ...
    beforeEach(() => {
        ...
        useCase = new cancelAppointment_usecase_1.CancelAppointmentUseCase(mockAppointmentRepo, mockConsultationRepo, mockSendNotificationUseCase, mockPaymentRepo, mockRazorpayService, mockWalletRepo, mockQueueService, mockSocketService, mockRefundAppointmentUseCase);
        jest.clearAllMocks();
    });
