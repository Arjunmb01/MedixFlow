...
const getDoctorDashboardStats_usecase_1 = require("@/application/use-cases/doctor/getDoctorDashboardStats.usecase");
describe('GetDoctorDashboardStatsUseCase', () => {
    ...
    beforeEach(() => {
        ...
        useCase = new getDoctorDashboardStats_usecase_1.GetDoctorDashboardStatsUseCase(mockDoctorRepo, mockDateTimeService);
        jest.clearAllMocks();
    });
