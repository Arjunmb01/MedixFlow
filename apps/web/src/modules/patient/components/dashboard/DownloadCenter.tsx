...
const downloads = [
    { name: "Prescriptions", icon: Pill, color: "text-orange-500" },
    { name: "Reports", icon: ClipboardList, color: "text-blue-500" },
    { name: "Invoices", icon: FileText, color: "text-gray-400" },
]
        ...
        <Card className="border-none shadow-sm rounded-[2rem] p-8 h-full flex flex-col">
            ...
            <div className="space-y-4 flex-1">
                {downloads.map((item, i) => (
                    <div key={i} className="flex items-center justify-between p-3 rounded-2xl hover:bg-gray-50 transition-colors group cursor-pointer border border-transparent hover:border-gray-100">
